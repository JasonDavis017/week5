...
rollButton.addEventListener(`click`, async function(event){
  ...
  let die1Img = document.querySelector(`.die1`)
  die1Img.setAttribute(`src`, `../images/dice/${die1}.png`)

  // - Replace the second die image using the second random value (hint: setAttribute)
  let die2Img = document.querySelector(`.die2`)
  die2Img.setAttribute(`src`, `../images/dice/${die2}.png`)
